...
MANAGER_CHOICES = ((str(p.id), p.first_name + " " + p.last_name) for p in Profile.objects.all())
MEMBER_CHOICES = ((str(p.id), p.first_name + " " + p.last_name) for p in Profile.objects.all())
